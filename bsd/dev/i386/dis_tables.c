 ...
 */
const instable_t dis_op0F01[240] = {

/*  [00]  */	TNSZ("sgdt",VMx,6),	TNSZ("sidt",MONITOR_MWAIT,6),	TNSZ("lgdt",XGETBV_XSETBV,6),	TNSZ("lidt",SVM,6),
/*  [04]  */	TNSZ("smsw",M,2),	INVALID, 		TNSZ("lmsw",M,2),	TNS("invlpg",SWAPGS_RDTSCP),
...
/*  [D8]  */	TNS("vmrun",SVM), 	INVALID,		TNS("vmload",SVM),	TNS("vmsave",SVM),
/*  [DC]  */	TNS("stgi",SVM), 	TNS("clgi",SVM),TNS("skinit",SVM),	TNS("invlpga",SVM),
};
